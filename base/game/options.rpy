...
define config.name = _("The Doll House")
...
define config.version = "Anniversary_Edition"


## Text that is placed on the game's about screen. To insert a blank line
## between paragraphs, write \n\n.

define gui.about = _("Plot:\n\n主角被變成人偶並放在店內，記憶亦失去了，但能在有限的時間內活動。\n\n主角將和同伴，在有限時間內完成任務，尋找自己記憶，和自己變為人偶的真相...\n\nDevelopers:\n\nFirst Edition:\n\n    Script:\n        Hau Ling CHEUNG\n        Wai Lok LUI\n        Yi Sum CHAN\n        Sin Nam WONG\n\n    Illustrator:\n        Fong Ching WAI\n\n    Coding:\n        Kai Cheong Wong\n\nAnniversary Edition\n    Reengineering:\n\n        Yorozuya Gen-Chen\n        Kai Cheong Wong\n        Sin Nam WONG\n        Fong Ching WAI")
...
define build.name = "The_Doll_House"
...
define config.save_directory = "am-1510505792"
